...
<?php echo "<h3 align='left'>  <font color='blue'><b>".str_repeat('&nbsp', 50)." Smart Insure Save your Life & health ".str_repeat('&nbsp', 50)."<span id='txt'> </span>". str_repeat('&nbsp', 70). "<span id='greating'> </span>&nbsp&nbsp&nbsp&nbsp". strtoupper( $_SESSION['name']) . "</b></font> </h3> " ?>  
...
<!--<a title="News"href="news.php"target="content">News</a><br><br> -->
